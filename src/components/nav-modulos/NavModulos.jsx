    ...
    <div className="container-campo-recolhivel">
      <div className="grupo-content">
        ...
        >
          ...
          <a className="link-cta" href="https://simpatiaunifenas.web.app/modules/professor" target="_blank">
            Ver todos
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        >
          ...
          <a className="link-cta" href="https://simpatiaunifenas.web.app/modules/aluno" target="_blank">
            Ver todos
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
      ...
      <div className="grupo-content-modulos">
        ...
        <div className="content-grid-modulos">
          {MODULOS_DATA[selecionado].map((modulo, index) => (
            <a key={index} className="op-modulo" href={modulo.link} target="_blank">
